...
Die erzeugten Bilder sind hierbei vom Menschen nicht als Verkehrszeichen wahrnehmbar. Jedoch klassifizierte das Black Box Modell 20 der 43 erzeugten Bilder mit einer Konfidenz von über 90\% als Verkehrszeichen. 
...
Bei Abbildung oben rechts wird im Algorithmus „Ausschließlich links“ als Zielklasse angegeben. Das erzeugte Bild wird mit einer Konfidenz von 95,35\% vom Black Box Modell als „Kreisverkehr“ erkannt.
Bei Abbildung unten links wird im Algorithmus „Links vorbei“ als Zielklasse angegeben. Das erzeugte Bild wird mit einer Konfidenz von 99,50\% als „Rechts vorbei“ vom Black Box Modell erkannt.
